  ...
  return (
    <>
      <Card className="overflow-hidden border-0 bg-background shadow-none">
        {/* Header */}
        <CardHeader className="border-b px-0 pb-5">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            {orderList && orderList.length > 0 && (
              <div className="flex items-center gap-2 rounded-full border bg-muted/40 px-4 py-2 text-sm">
          ...
          {orderList && orderList.length > 0 ? (
            ...
            <div className="flex min-h-[300px] flex-col items-center justify-center rounded-2xl border border-dashed bg-muted/20 px-6 text-center">
              ...
              <p className="mt-2 max-w-sm text-sm text-muted-foreground">
                Your completed and current orders will appear here once you
